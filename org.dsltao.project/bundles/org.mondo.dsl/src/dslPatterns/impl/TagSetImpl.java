 ...
 * </p>
 * <ul>
 *   <li>{@link dslPatterns.impl.TagSetImpl#getTags <em>Tags</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TagSetImpl extends EObjectImpl implements TagSet {
	...
	protected EClass eStaticClass() {
		return DslPatternsPackage.Literals.TAG_SET;
	}
	...
	public EList<Tag> getTags() {
		if (tags == null) {
			tags = new EObjectContainmentEList<Tag>(Tag.class, this, DslPatternsPackage.TAG_SET__TAGS);
		}
		return tags;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DslPatternsPackage.TAG_SET__TAGS:
