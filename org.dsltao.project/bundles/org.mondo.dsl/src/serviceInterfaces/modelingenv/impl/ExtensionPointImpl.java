...
public class ExtensionPointImpl extends EObjectImpl implements ExtensionPoint {
	...
	protected EClass eStaticClass() {
		return ModelingenvPackage.Literals.EXTENSION_POINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelingenvPackage.EXTENSION_POINT__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelingenvPackage.EXTENSION_POINT__ID:
				return getId();
		}
