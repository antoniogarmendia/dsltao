 ...
 * @generated
 */
public class JavaInterfaceImpl extends JavaTypeDeclarationImpl implements JavaInterface {
	/**
	...
	protected EClass eStaticClass() {
		return ModelingenvPackage.Literals.JAVA_INTERFACE;
	}
	...
	public EList<Operation> getOperations() {
		if (operations == null) {
			operations = new EObjectContainmentEList<Operation>(Operation.class, this, ModelingenvPackage.JAVA_INTERFACE__OPERATIONS);
		}
		return operations;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelingenvPackage.JAVA_INTERFACE__OPERATIONS:
