...
public abstract class PointcutImpl extends EObjectImpl implements Pointcut {
	 ...
	 * @ordered
	 */
	protected static final PointcutType TYPE_EDEFAULT = PointcutType.BEFORE;
	 ...
	 * @ordered
	 */
	protected PointcutType type = TYPE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return CodegenPackage.Literals.POINTCUT;
	}
	 ...
	 * @generated
	 */
	public void setType(PointcutType newType) {
		PointcutType oldType = type;
		type = newType == null ? TYPE_EDEFAULT : newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodegenPackage.POINTCUT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CodegenPackage.POINTCUT__TYPE:
				return getType();
		}
