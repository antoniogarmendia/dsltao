/**
 */
package serviceInterfaces.util;
 ...
 * @generated
 */
public class ServiceInterfacesAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static ServiceInterfacesPackage modelPackage;
	 ...
	 * @generated
	 */
	public ServiceInterfacesAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = ServiceInterfacesPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected ServiceInterfacesSwitch<Adapter> modelSwitch =
		new ServiceInterfacesSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter casePackage(serviceInterfaces.Package object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link serviceInterfaces.InterfaceRepository <em>Interface Repository</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link serviceInterfaces.Package <em>Package</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
...
} //ServiceInterfacesAdapterFactory
