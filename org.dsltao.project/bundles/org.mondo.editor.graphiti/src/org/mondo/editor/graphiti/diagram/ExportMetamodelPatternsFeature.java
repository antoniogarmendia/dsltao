 ...
 *
 */
public class ExportMetamodelPatternsFeature extends AbstractCustomFeature {
 
    private boolean hasDoneChanges = false;
      
    public ExportMetamodelPatternsFeature(IFeatureProvider fp) {
        super(fp);
    }
 
    @Override
    public String getName() {
        return "Export Meta-model+Patterns...";
    }
 
    @Override
    public String getDescription() {
        return "Export Meta-model and Patterns";
    }
	    		...
	    		String path=fileDialog.open();
  		  		...
  		  		*/
					...
					copier2.copyReferences();
	  		  		EObject result2 = copier2.copy(obj);
	  		  		*/
