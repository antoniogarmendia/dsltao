...
/**
 * Class to take down an EAttribute object within the EClass object.
 * 
 * @author miso partner AnaPescador
 *
 */
public class DownEAttributeFeature extends AbstractCustomFeature {
 
    private boolean hasDoneChanges = false;
      
    public DownEAttributeFeature(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public String getDescription() {
        return "Take down the attribute";
    }
    
    @Override
	public String getImageId() {
		return EcoreImageProvider.IMG_DOWN;
	}
    ...
    private boolean hasNext(Shape shape){
