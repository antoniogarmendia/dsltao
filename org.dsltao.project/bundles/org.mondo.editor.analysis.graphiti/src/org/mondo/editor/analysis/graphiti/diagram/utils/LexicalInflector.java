...
public class LexicalInflector {
    ...
    public static boolean isPlural(final String word){    	
    	if(pluralize(singularize(word)).equals(word) && !word.equals(singularize(word))) return true;    	
    	return false;
    }
    
    public static boolean isSingular(final String word){    	
    	if(uncountables.contains(word)) return true;
    	if(pluralize(singularize(word)).equals(pluralize(word)) && !word.equals(pluralize(word))) return true;
    	return false;
    }
